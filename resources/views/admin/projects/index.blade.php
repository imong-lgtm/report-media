...
<div class="flex justify-between items-center mb-8">
    ...
    <a href="{{ route('admin.projects.create') }}" class="px-6 py-3 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 transition shadow-lg shadow-blue-600/20">
        Add New Project
    </a>
</div>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr>
                    <td class="px-8 py-5">
                        <div class="flex items-center gap-4">
                            <img src="{{ $project->image }}" class="h-12 w-12 rounded-xl object-cover">
                            <span class="font-bold text-gray-900">{{ $project->title }}</span>
                        </div>
                    </td>
                    <td class="px-8 py-5 text-gray-600">{{ $project->category }}</td>
                ...
                @empty
                <tr>
                    <td colspan="3" class="px-8 py-10 text-center text-gray-500">No projects found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
