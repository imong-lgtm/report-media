...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="px-8 py-6 border-b border-gray-100 flex justify-between items-center">
        ...
        <a href="#" class="text-sm font-bold text-blue-600 hover:text-blue-700 transition">View All Messages</a>
    </div>
        ...
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr>
                    ...
                    <td class="px-8 py-5">
                        <button class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm font-bold hover:bg-gray-200 transition">View</button>
                    </td>
                </tr>
                @empty
                <tr>
